...
async def handle_list_tools() -> List[Tool]:
    ...
    tools = [
        # Real-time status tools (migrated from vrm_server)
        Tool(
            name="get_equipment_status",
            description=(
                "Get current real-time status of equipment at a grid site. "
                "Returns inverter power per phase, battery state of charge, "
            ...
            inputSchema={
                ...
                "properties": {
                    "grid_name": {
                        "type": "string",
                        "description": "Name of the grid site (fuzzy matching supported)",
                    },
                    "metrics": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": (
                            "Specific metrics to retrieve: 'inverter', 'battery', "
                            "'grid', 'pv', 'alarms'. Defaults to all."
                        ),
                        "default": ["inverter", "battery", "grid", "pv", "alarms"],
                    },
                },
                "required": ["grid_name"],
            },
        ...
        Tool(
            name="get_site_info",
            description=(
                "Get general site information including online/offline status, "
                "phase configuration, equipment counts, and location."
            ),
            inputSchema={
                "type": "object",
                "properties": {
        ...
        Tool(
            ...
            description=(
                "Get detailed equipment inventory including inverters, batteries, "
                "and MPPTs with serial numbers and model information."
            ),
            inputSchema={
                "type": "object",
                "properties": {
        ...
        Tool(
            ...
            description=(
                "Get historical power data for analysis. Can detect grid outages, "
                "find peak loads, and analyze power patterns. "
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "start_time": {
                        "type": "string",
                        "description": "ISO datetime for custom range start",
                    },
                    "end_time": {
                        "type": "string",
                        "description": "ISO datetime for custom range end",
                    },
                    "metrics": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": (
                            "Metrics to include: 'grid_consumption' (o1-o3, total load-side "
                            "consumption), 'grid_power', 'battery_soc', 'battery_power', 'pv_power'"
                        ),
                        "default": ["grid_power", "grid_consumption", "battery_soc"],
                    },
                    "analysis": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": (
                            "Analysis to perform: 'outages', 'peak_load', "
                            "'phase_analysis', 'summary_stats'"
                        ),
                        "default": [],
                    },
                },
        ...
        Tool(
            ...
            description=(
                "Get historical performance data for one or more specific MPPTs. "
                "Provides a time-series of estimated vs. actual power generation, "
                "which is essential for diagnosing underperformance of a specific solar charger."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    "grid_name": {
                        "type": "string",
                        "description": "Name of the grid site where the MPPTs are located",
                    },
                    "time_range": {
                        "type": "string",
                        "enum": [
                    ...
                    "mppt_serial_numbers": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Optional list of MPPT serial numbers to query. If omitted, returns data for all MPPTs on the grid.",
                    },
                },
                "required": ["grid_name"],
            },
        ...
        Tool(
            ...
            description=(
                "Analyze a specific grid outage event in detail. "
                "Identifies affected phases, load at failure, recovery pattern."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "outage_time": {
                        "type": "string",
                        "description": (
                            "Approximate time of outage (ISO datetime). "
                            "If not provided, finds the most recent outage."
                        ),
                    },
                    "search_window_minutes": {
                        "type": "integer",
                        "description": "Minutes around outage_time to search",
                        "default": 60,
                    },
                },
                "required": ["grid_name"],
        ...
        Tool(
            ...
            description=(
                "Generate a chart visualizing power data over time. "
                "Returns PNG image suitable for Telegram."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "highlight_events": {
                        "type": "boolean",
                        "description": "Highlight outage events on the chart",
                        "default": True,
                    },
                },
        ...
        # Batch operations for /grids command
        Tool(
            name="get_batch_downtime_summary",
            description=(
                "Get 24-hour downtime summary for multiple grids in parallel. "
                "Efficient batch operation with concurrency control. "
                "Returns total downtime minutes, outage count, and status icon per grid."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "max_concurrent": {
                        "type": "integer",
                        "description": "Max parallel API calls (default: 5)",
                        "default": 5,
                    },
                },
                "required": ["grid_names"],
        ...
        Tool(
            ...
            description=(
                "Schedule a follow-up check of equipment status. "
                "Useful after control actions (restart inverter, reboot comms) "
                "to verify success. Default: 5 min for inverter, 12 min for comms."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "delay_minutes": {
                        "type": "integer",
                        "description": "Minutes to wait before check",
                        "default": 5,
                    },
                    "check_type": {
                        "type": "string",
                    ...
                    "expected_condition": {
                        "type": "string",
                        "description": (
                            "Expected condition to verify "
                            "(e.g., 'grid_consumption > 1000', 'is_online == true')"
                        ),
                    },
                    "notify_on_failure": {
                        "type": "boolean",
                        "description": "Send alert if expected condition not met",
                        "default": True,
                    },
                },
                "required": ["grid_name"],
