...
async def _resolve_notify_ticket_llm_judgment(
    ...
    async def episodic_provider():
        from orchestrator.services.grid_context_feeds import fetch_episodic_summary_for_scope

        return await fetch_episodic_summary_for_scope(grid=target.grid_name, is_staff=True)
    ...
    context = await AlertJudgmentContextAssembler(
        ...
        episodic_summary_provider=episodic_provider,
