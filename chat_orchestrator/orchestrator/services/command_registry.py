...
COMMAND_REGISTRY: Dict[str, CommandDefinition] = {
    ...
    "grid": CommandDefinition(
        ...
        prompt_template=(
            ...
            "**Service Status**: service (FS/HPS/Isolated/Off/Unknown, verbatim from service_status.service — the same processed status /grids shows), "
            "weather (from live_weather.display e.g. '☀️ 32°C'), "
