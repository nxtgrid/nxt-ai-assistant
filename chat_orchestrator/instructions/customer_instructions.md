...
User: Can you help me set up a new agent account with restricted access to Ayrton?

Bot: I'm not able to configure custom access levels for Ayrton accounts. All team members have the same access once onboarded.
